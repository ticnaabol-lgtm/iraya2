...
@section('content')
        ...
        <form id="formReportePDF">
            <div class="card">
                <div class="card-header">
                    <h2 class="doc-section-title" id="raised">Formulario 002</h2>
                </div>
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-md-6">
        ...
        <div class="modal-dialog modal-xxl-custom">
            <div class="modal-content">
                ...
                <div class="modal-body p-0">
                    <iframe id="iframeReportePDF" src="" width="100%" height="900px" frameborder="0"></iframe>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        document.getElementById('formReportePDF').addEventListener('submit', function(e) {
            ...
            const url =
                `/reporte/formulario002_pdf?desde=${encodeURIComponent(desde)}&hasta=${encodeURIComponent(hasta)}&estado=${encodeURIComponent(estado)}`;
    ...
    <script>
        document.getElementById('reporte_excel').addEventListener('click', function() {
            ...
            const url = new URL("{{ route('reporte.formulario002_excel') }}", window.location.origin);
