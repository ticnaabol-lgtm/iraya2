        ...
        <div class="modal-content border border-primary shadow">
            <div class="modal-header bg-white text-white">
                <h4 class="modal-title fw-bold text-uppercase">
                    AUTORIZACIÓN <span id="detalle_tipo_autorizacion"></span>&nbsp;&nbsp;<span
            ...
            <div class="modal-body">
                <div class="row mb-2">
                    ...
                    <div class="col-3" id="detalle_fecha_autorizacion"></div>
                    <div class="col-3 fw-bold">Documento Autorización:</div>
                    <div class="col-3" id="detalle_pdf_autorizacion"></div>
                </div>
                <div class="row mb-2">
                ...
                <div class="row mb-2">
                    <div class="col-3 fw-bold">Documento Adjunto:</div>
                    <div class="col-9" id="detalle_pdf_adjunto"></div>
                </div>
                <div class="row mb-2">
                ...
                <div class="row mb-2">
                 ...
                 <div class="row mb-2">
                    <div class="col-3 fw-bold">Enmienda:</div>
                    <div class="col-9" id="detalle_enmienda"></div>
                </div>
